...
public class UiMovingCloud : UiCloud
{
    ...
    public override IEnumerator Fade()
    {
        ...
        {
            color.a = alpha;
            GetComponent<RectTransform>().anchoredPosition = Vector3.Lerp(innerpoint, outerpoint, (baseAlpha - alpha) * (baseAlpha - alpha));
